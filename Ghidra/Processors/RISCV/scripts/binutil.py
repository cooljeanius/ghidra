...
def match_opcode(op, insn):
    print(
        "match_opcode: %08x %08x %08x %08x %08x"
        % (op.match, op.mask, insn, insn ^ op.match, (insn ^ op.match) & op.mask)
    )
...
opcodes = [
    ...
    (
        ...
        ISAI,
        "",
        MATCH_CSRRW | (CSR_CYCLE << OP_SH_CSR),
        0xFFFFFFFF,
        match_opcode,
        0,
    ),  # /* csrw cycle, x0 */
    ...
    (
        ...
        MASK_C_LWSP,
        match_rd_nonzero,
        INSN_ALIAS | INSN_DREF | INSN_4_BYTE,
    ),
    (
        "lw",
        0,
    ...
    (
        ...
        ISAI,
        "d,s",
        MATCH_SLTIU | ENCODE_ITYPE_IMM(1),
        MASK_SLTIU | MASK_IMM,
        match_opcode,
        INSN_ALIAS,
    ),
    ...
    (
        ...
        ISAI,
        "",
        MATCH_FENCE | MASK_PRED | MASK_SUCC,
        MASK_FENCE | MASK_RD | MASK_RS1 | MASK_IMM,
        match_opcode,
        INSN_ALIAS,
    ),
    (
        ...
        "P,Q",
        MATCH_FENCE,
        MASK_FENCE | MASK_RD | MASK_RS1 | (MASK_IMM & ~MASK_PRED & ~MASK_SUCC),
        match_opcode,
        0,
    ),
    (
    ...
    (
        ...
        "",
        MATCH_FENCE_TSO,
        MASK_FENCE_TSO | MASK_RD | MASK_RS1,
        match_opcode,
        INSN_ALIAS,
    ),
    ...
    (
        ...
        MASK_C_LDSP,
        match_rd_nonzero,
        INSN_ALIAS | INSN_DREF | INSN_8_BYTE,
    ),
    (
        "ld",
        64,
    ...
    (
        ...
        ISAF,
        "D,S",
        MATCH_FSQRT_S | MASK_RM,
        MASK_FSQRT_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "D,S,T,R",
        MATCH_FMADD_S | MASK_RM,
        MASK_FMADD_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "D,S,T,R",
        MATCH_FNMADD_S | MASK_RM,
        MASK_FNMADD_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "D,S,T,R",
        MATCH_FMSUB_S | MASK_RM,
        MASK_FMSUB_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "D,S,T,R",
        MATCH_FNMSUB_S | MASK_RM,
        MASK_FNMSUB_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "d,S",
        MATCH_FCVT_W_S | MASK_RM,
        MASK_FCVT_W_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "d,S",
        MATCH_FCVT_WU_S | MASK_RM,
        MASK_FCVT_WU_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "D,s",
        MATCH_FCVT_S_W | MASK_RM,
        MASK_FCVT_S_W | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "d,S",
        MATCH_FCVT_L_S | MASK_RM,
        MASK_FCVT_L_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "d,S",
        MATCH_FCVT_LU_S | MASK_RM,
        MASK_FCVT_LU_S | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAF,
        "D,s",
        MATCH_FCVT_S_L | MASK_RM,
        MASK_FCVT_S_L | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "D,S",
        MATCH_FSQRT_D | MASK_RM,
        MASK_FSQRT_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "D,S,T,R",
        MATCH_FMADD_D | MASK_RM,
        MASK_FMADD_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "D,S,T,R",
        MATCH_FNMADD_D | MASK_RM,
        MASK_FNMADD_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "D,S,T,R",
        MATCH_FMSUB_D | MASK_RM,
        MASK_FMSUB_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "D,S,T,R",
        MATCH_FNMSUB_D | MASK_RM,
        MASK_FNMSUB_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "d,S",
        MATCH_FCVT_W_D | MASK_RM,
        MASK_FCVT_W_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "d,S",
        MATCH_FCVT_WU_D | MASK_RM,
        MASK_FCVT_WU_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "D,S",
        MATCH_FCVT_S_D | MASK_RM,
        MASK_FCVT_S_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "d,S",
        MATCH_FCVT_L_D | MASK_RM,
        MASK_FCVT_L_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "d,S",
        MATCH_FCVT_LU_D | MASK_RM,
        MASK_FCVT_LU_D | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAD,
        "D,s",
        MATCH_FCVT_D_L | MASK_RM,
        MASK_FCVT_D_L | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,S",
        MATCH_FSQRT_Q | MASK_RM,
        MASK_FSQRT_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,S,T,R",
        MATCH_FMADD_Q | MASK_RM,
        MASK_FMADD_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,S,T,R",
        MATCH_FNMADD_Q | MASK_RM,
        MASK_FNMADD_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,S,T,R",
        MATCH_FMSUB_Q | MASK_RM,
        MASK_FMSUB_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,S,T,R",
        MATCH_FNMSUB_Q | MASK_RM,
        MASK_FNMSUB_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "d,S",
        MATCH_FCVT_W_Q | MASK_RM,
        MASK_FCVT_W_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "d,S",
        MATCH_FCVT_WU_Q | MASK_RM,
        MASK_FCVT_WU_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,S",
        MATCH_FCVT_S_Q | MASK_RM,
        MASK_FCVT_S_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,S",
        MATCH_FCVT_D_Q | MASK_RM,
        MASK_FCVT_D_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "d,S",
        MATCH_FCVT_L_Q | MASK_RM,
        MASK_FCVT_L_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "d,S",
        MATCH_FCVT_LU_Q | MASK_RM,
        MASK_FCVT_LU_Q | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        ISAQ,
        "D,s",
        MATCH_FCVT_Q_L | MASK_RM,
        MASK_FCVT_Q_L | MASK_RM,
        match_opcode,
        0,
    ),
    ...
    (
        ...
        "",
        MATCH_SFENCE_VMA,
        MASK_SFENCE_VMA | MASK_RS1 | MASK_RS2,
        match_opcode,
        INSN_ALIAS,
    ),
    (
...
def parse_CI(op, rv):
    ...
    if op.bitpattern.count("clwspimm") == 1:
        ...
        elif (x == 1 and (rv == 32 or rv == 64)) or (
            x == 3 and (rv == 64 or rv == 128)
        ):
...
def opcode_map_c(op):
    ...
    if x == 0 and y == 0:
        ...
        if op.name.find("jal") >= 0:
            ...
            print("#TODO  {} {}".format(op.display, " & ".join(op.bitpattern)))
            pass
        elif op.name == "addw":
            print("#TODO  {} {}".format(op.display, " & ".join(op.bitpattern)))
            pass
        ...
        if op.name.find("lui") >= 0:
            parse_CI(op, None)
        elif op.name.find("addi16sp") >= 0:
            parse_CJ(op, None)
        elif op.name == "li":
            print("#TODO  {} {}".format(op.display, " & ".join(op.bitpattern)))
            pass
        ...
        if op.name.find("jr") >= 0:
            parse_CI(op, None)
        elif op.name.find("jalr") >= 0:
            parse_CI(op, None)
        elif op.name.find("mv") >= 0:
            parse_CR(op, None)
        elif op.name.find("add") >= 0:
            parse_CR(op, None)
        elif op.name == "ebreak":
            parse_CJ(op, None)
