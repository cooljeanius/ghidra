...
if os.path.isdir(f"{home}\\ghidra\\.git"):
    ...
    sys.path.append(f"{home}\\Ghidra\\Debug\\Debugger-agent-dbgeng\\build\\pypkg\\src")
    sys.path.append(f"{home}\\Ghidra\\Debug\\Debugger-rmi-trace\\build\\pypkg\\src")
else:
    sys.path.append(f"{home}\\Ghidra\\Debug\\Debugger-agent-dbgeng\\pypkg\\src")
...
def main():
    ...
    cmd.ghidra_trace_attach(os.getenv("OPT_TARGET_PID"), flags, start_trace=False)
